    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                ...
                <a href="leavingCert.php" class="btn btn-primary btn-xl page-scroll">Leaving Certificate</a>
                <a href="college.php" class="btn btn-primary btn-xl page-scroll">College Courses</a>
